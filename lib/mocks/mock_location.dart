import 'package:fcc_location_app/location_detail.dart';
import 'package:fcc_location_app/models/location_fact.dart';
    ...
    Location(
        ...
        facts: <LocationFact>[
          LocationFact(
            title: 'Summary',
            text:
                'While we could go on about the ethereal glow and seemlingly endless heights of this bamboo grove on the outskirts of Kyoto, the sight\'s pleasures extend beyond the visual realm',
          ),
          LocationFact(
